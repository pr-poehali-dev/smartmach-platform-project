...
import { FONT, MODULES, CHALLENGES } from "./landing.data";
...
function ModulesSection() {
  return (
    <section id="modules" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <SectionLabel text="Архитектура решения" />
        <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4" style={FONT}>
          Шесть контуров единого<br />цифрового пространства данных
        </h2>
        <p className="text-muted-foreground text-base mb-12 max-w-2xl">
          Каждый контур реализует алгоритм валидации и передаёт верифицированные данные
          следующему. Переход между контурами возможен только при соответствии версий —
          это исключает накопление рассогласований по цепочке КД→CAE→CAM→MES.
        </p>
...
export default function LandingProduct({ onEnter }: LandingProductProps) {
  return (
    <>
