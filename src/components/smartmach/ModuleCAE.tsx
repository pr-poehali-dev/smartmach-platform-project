    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-5">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground leading-tight">Расчёты — CAE</h1>
          <p className="text-muted-foreground text-sm mt-0.5 hidden sm:block">МКЭ-расчёты: прочность, тепло, динамика, усталость</p>
        </div>
        <button onClick={() => setShowForm(true)}
          ...
          <Icon name="Plus" size={16} /><span className="hidden sm:inline">Новый расчёт</span><span className="sm:hidden">Расчёт</span>
        </button>
      </div>
