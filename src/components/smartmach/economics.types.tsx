...
export interface Employee { id: number; full_name: string; position: string; department: string; status: string; }
...
export interface CalcResult {
  monthHours: number; salaryTotal: number; salaryWithTax: number;
  overheadTotal: number; fixedTotal: number; machineHourRate: number;
  productCalcs: ProductCalc[];
  totalRevenue: number; totalCost: number; totalProfit: number;
  workshopMargin: number; breakEvenRevenue: number;
